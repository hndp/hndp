...
while True:
    ...
    if choice in ('iphone 11 pro'):
        iphone11pro_64.iphone11pro()
        iphone11pro_256.iphone11pro()
        iphone11pro_512.iphone11pro()

    if choice in ('iphone pro max'):
        iphone11promax_64.iphone11promax()
        iphone11promax_256.iphone11promax()
        iphone11promax_512.iphone11promax()
    if choice in ('iphone 11 pro max'):
        iphone11promax_64.iphone11promax()
        iphone11promax_256.iphone11promax()
        iphone11promax_512.iphone11promax()
    ...
    if choice in ('imac'):
        ...
        imac21.imac()
    elif choice in ('imac 27', 'imac 27 inch', 'imac27'):
        imac27.imac()
    ...
    #[Usb / Adapter -]
    elif choice in ('usb adapter', 'usb'):
        usbadapter.acc()

    #[Mouse -]
    elif choice in ('magicmouse2', 'magic mouse 2', 'magic mouse', 'mouse'):
        magicmouse2.acc()

    #[Trackpad -]
    elif choice in ('magictrackpad2', 'magic trackpad', 'magic trackpad 2', 'trackpad', 'trackpad 2'):
        magictrackpad2.acc()

    #[Air Pods -]
    elif choice in ('air pods pro', 'air pods', 'air pod'):
        airpodspro.acc()

    #[Macbook acc -]
    elif choice in ('macbook sleeve', 'macbook air sleeve', 'macbook pro sleeve'):
        mac13sleeve.acc()
        mac16sleeve.acc()
    ...
    #[iPhone case -]
    elif choice in ('silicone case', 'iphone case', 'iphone silicone', 'iphone pro case', 'iphone 11 case',
    ...
    #[iPhone blue case -]
    elif choice in ('iphone 11 silicone blue', 'iphone 11 midnight blue', 'iphone 11 midnight blue case'):
        iph11siliconemidblue.acc()
    ...
    #[iPhone black case -]
    elif choice in ('iphone 11 silicone black', 'iphone 11 black', 'iphone 11 black case'
